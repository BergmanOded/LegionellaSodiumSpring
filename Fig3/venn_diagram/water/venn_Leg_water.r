...
otu <- read.table(file = "/home/oded/Documents/post/articles/springs/feature_count/20/water/last5/feature-table.tsv", sep = "\t", header = T, row.names = 1, 
                  skip = 1, comment.char = "")
...
write.csv(otu_cluster,"/home/oded/Documents/post/articles/springs/NGS/venn_diagram/water/otu_cluster.csv", row.names = TRUE)
...
grid.draw(venn_springs_water)
  ...
  pdf("/home/oded/Documents/post/articles/springs/final R code/NGS/16S/venn_diagram/venn_water_Leg.pdf",  width = 12, height = 6.5, family="ArialMT")
grid.draw(venn_springs_water)
dev.off()
