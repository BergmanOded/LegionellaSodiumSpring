...
library(viridis)
library(pheatmap)
otu <- read.table(file = "/home/oded/Documents/post/articles/springs/18S/NGS/heatmap/Na/filter500/filter-separate/qiime2_convert_tsv/reordered/biofilm/relative_abundance/last5/feature-table.tsv", sep = "\t", header = T, row.names = 1, 
                  skip = 1, comment.char = "")
...
metadata <- read.table(file = "/home/oded/Documents/post/articles/springs/18S/NGS/heatmap/Na/filter500/filter-separate/qiime2_convert_tsv/reordered/biofilm/relative_abundance/sample-metadata.tsv", sep = "\t", header = T, row.names = 1)
...
# t() - transposes the matrix. So we have to change the lol to wors... 
  ...
  png("/home/oded/Documents/post/articles/springs/18S/NGS/heatmap/Na/filter500/filter-separate/qiime2_convert_tsv/reordered/biofilm/relative_abundance/last5/12.22.21_Legionella_host_biofilm500_Na.png",  width = 14800, height = 9000, res = 1200)
  p.heatmap.biofilm
  dev.off()
