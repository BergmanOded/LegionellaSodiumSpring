...
otu_table_host <- read.table("/home/oded/Documents/post/articles/springs/speiceaci/water20/Haon-THS/hosts_features/last5/feature-table.tsv", sep = "\t", header = T, row.names = 1, skip = 1, comment.char = "")  
otu_table_Leg <- read.table("/home/oded/Documents/post/articles/springs/speiceaci/water20/Haon-THS/Legionella_features/last5/feature-table_speiceaci.tsv", sep = "\t", header = T, row.names = 1, skip = 1, comment.char = "")  
metadata <- read.table(file = "/home/oded/Documents/post/articles/springs/speiceaci/water20/Haon-THS/sample-metadata.tsv", sep = "\t", header = T, row.names = 1)
...
# we want to creat weighted network!
...
grph.pos.con.cross <- delete_vertices(grph.pos.con, 46) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 64) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 54)
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 52) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 49) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 48) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 81) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 78) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 21) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 8)
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 69) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 96) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 91) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 89) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 88) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 80) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 64) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 53) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 95) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 56) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 65) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 51) 
grph.pos.con.cross <- delete_vertices(grph.pos.con.cross, 37) 


# lets look at the  vertices (nodes) 
V(grph.pos.con.cross)
  # and at the edges of the network
edge_list <- E(grph.pos.con.cross)
print(edge_list , full=TRUE)

plot(grph.pos.con.cross, vertex.label.cex=0.5, vertex.label.color="black", 
     edge.color="black",
     layout=layout_with_fr(grph.pos.con.cross))

pdf("/home/oded/Documents/post/articles/springs/speiceaci/water20/Haon-THS/to_report/water_speiceaci.pdf")
dev.off()
...
png(file = "/home/oded/Documents/post/articles/springs/speiceaci/water20/Haon-THS/NETWORK_FIG/biofilm_speiceaci.png", width = 4000, height = 8000)
